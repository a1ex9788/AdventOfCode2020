...
namespace AdventOfCode2020Tests
{
    ...
    public class Day04Tests : Tester
    {
        ...
        protected override string OutputPart1 => Resources.Day04Part1Output;
        protected override string OutputPart2 => Resources.Day04Part2Output;
        ...
        public void ContainsRequiredFieldsTest(string passport, bool isValid)
        {
            Assert.AreEqual(isValid, Day04.ContainsRequiredFields(passport));
        }
        ...
        public void ContainsRequiredFieldsAndHaveValidValuesTest(string passport, bool isValid)
        {
            Assert.AreEqual(isValid, Day04.ContainsRequiredFieldsAndHaveValidValues(passport));
        }
    }
}